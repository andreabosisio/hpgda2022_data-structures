...
int main(int argc, char **argv)
{
    ...
    if (debug)
        std::cout << "Edge list size: " << resident_set_size / 1024 << " MB" << std::endl
                  << std::endl;
    ...
    // print graph info
    if (debug)
        print_graph_info(num_vertices, num_edges, undirected);
    ...
    for (uint64_t i = 0; i < num_iterations; i++)
    {
        ...
        if (debug)
            std::cout << "Graph size: " << rss_tmp / 1024 << " MB" << std::endl
                      << std::endl;
        else
        ...
        {   
            ...
            if (debug)
            {
                ...
                std::cout << "BFS results written in " << graphName + ".bfs" << std::endl
                          << std::endl;
            }
        }
        ...
        {   
            ...
            if (debug)
            {
                ...
                std::cout << "DFS results written in " << graphName + ".dfs" << std::endl
                          << std::endl;
            }
        }
